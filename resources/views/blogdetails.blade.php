...
<!--=================================Blog Details=========================================  -->
       <section class="product-page-container">
          <div><img src="./assets/images/product-bg-img.png" alt="image" class="mainProduct-relative-image"></div>
    <div class="container">
    ...
    <section class="mt-4 mb-4">
      ...
      <p> Discover the finest handcrafted textiles that blend heritage and modern elegance.</p>
          ...
          <div class="col-md-4 mt-4">
            <a href="{{url('blogdetails')}}" class="text-decoration-none">
              <div class="main-blogs-container">
               ...
               <div class="share-post-show">
                ...
                <a href="{{url('blogdetails')}}" class="text-decoration-none"><h1>Top 8 eCommerce personalization examples to boost sales</h1></a>
              </div>
            </a> 
          </div>
                <div class="col-md-4 mt-4">
